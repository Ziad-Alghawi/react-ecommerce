...
// setup producrt data and mock here

describe('Product component', () => {
    let product;
    // Mock the loadCart function
    let loadCart;
...
// Test to check if product details are displayed correctly
...
it('selects a quantity', async () => {
    ...
    const quantitySelector = screen.getByTestId('quantity-select-selector');
